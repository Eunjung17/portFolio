	...
	return (
		<section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
			<div className="text-center">
				...
				<h1 className="text-3xl sm:text-4xl font-bold text-white mb-3 sm:mb-4">Eunjung Kim</h1>
				<p className="text-lg sm:text-xl text-gray-300 mb-6 sm:mb-8">Full Stack Developer</p>
				<p className="text-gray-400 max-w-2xl mx-auto text-sm sm:text-base px-4">
					Results-oriented full-stack web developer with 3.5 years of experience, a Software Engineering certificate from Fullstack Academy, and a passion for continuously learning new technologies.
				</p>
			</div>
		</section>
	);
